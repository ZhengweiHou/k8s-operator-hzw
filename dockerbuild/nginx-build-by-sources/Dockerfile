...
RUN GPG_KEYS=B0F4253373F8F6F510D42178520A9993A1C052F8 \
	...
	&& curl -fSL http://192.168.104.139:8001/nginx-upstream-dynamic-servers-${NGINX_UPSTREAM_DYNAMIC_SERVERS_VERSION}.tar.gz  -o nginx-upstream-dynamic-servers.tar.gz \
...
#	gpg --batch --verify nginx.tar.gz.asc nginx.tar.gz \
	...
	&& mkdir -p /usr/src \
	&& tar -zxvC /usr/src -f nginx.tar.gz \
	&& tar -zxvC /usr/src -f nginx-sticky-module-ng.tar.gz \
	&& tar -zxvC /usr/src -f nginx-upstream-dynamic-servers.tar.gz \
	&& rm nginx.tar.gz \
